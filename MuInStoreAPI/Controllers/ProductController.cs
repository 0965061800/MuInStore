...
namespace MuInStoreAPI.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public ProductController(MuInDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        {
            ListProductService service = new ListProductService(_context, _mapper);
            var result = await service.SortFilterPage(sortFilterPageData).ProjectTo<ProductDto>(_mapper.ConfigurationProvider).ToListAsync();
            if (result == null)
            {
