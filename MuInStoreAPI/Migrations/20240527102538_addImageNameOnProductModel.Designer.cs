...
namespace MuInStoreAPI.Migrations
{
    ...
    [Migration("20240527102538_addImageNameOnProductModel")]
    partial class addImageNameOnProductModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f6efca68-aa5f-4b97-a882-b048e0df4cee",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "c3947b7c-495d-48f2-92c4-8d82be7008e2",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MuInStoreAPI.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BrandId = 2,
                            CategoryId = 1,
                            CreatAt = new DateTime(2024, 5, 27, 17, 25, 37, 33, DateTimeKind.Local).AddTicks(1832),
                        ...
                        new
                        {
                            ...
                            BrandId = 1,
                            CategoryId = 4,
                            CreatAt = new DateTime(2024, 5, 27, 17, 25, 37, 33, DateTimeKind.Local).AddTicks(1854),
                            Description = "Thông số kỹ thuật YAMAHA C1PE. Model C1 PE Màu sắc/Lớp hoàn thiện Thùng đàn Màu sắc Polished Ebony Lớp phủ Polished Kích cỡ/Trọng lượng Kích thước Rộng 149cm (59\") Cao 101cm (40\") Dày 161cm (5'3\") Trọng lượng Trọng lượng...",
                            FeatureId = 1,
                            ImageName = "",
                            ProductCode = "CT300",
                        ...
                        new
                        {
                            ...
                            BrandId = 1,
                            CategoryId = 4,
                            CreatAt = new DateTime(2024, 5, 27, 17, 25, 37, 33, DateTimeKind.Local).AddTicks(1860),
                            Description = "Thông số kỹ thuật YAMAHA C1PE. Model C1 PE Màu sắc/Lớp hoàn thiện Thùng đàn Màu sắc Polished Ebony Lớp phủ Polished Kích cỡ/Trọng lượng Kích thước Rộng 149cm (59\") Cao 101cm (40\") Dày 161cm (5'3\") Trọng lượng Trọng lượng...",
                            FeatureId = 2,
                            ImageName = "",
                        ...
                        new
                        {
                            ...
                            BrandId = 3,
                            CategoryId = 4,
                            CreatAt = new DateTime(2024, 5, 27, 17, 25, 37, 33, DateTimeKind.Local).AddTicks(1865),
